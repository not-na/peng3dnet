# -*- coding: utf-8 -*-
#
# Peng3dnet documentation build configuration file, created by
...
from peng3dnet import version as ver
...
html_use_opensearch = 'https://peng3dnet.readthedocs.org/en/latest/'
...
htmlhelp_basename = 'Peng3dnetdoc'
...
latex_documents = [
  (master_doc, 'Peng3dnet.tex', u'Peng3dnet Documentation',
   u'notna', 'manual'),
]
...
man_pages = [
    (master_doc, 'peng3dnet', u'Peng3dnet Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Peng3dnet', u'Peng3dnet Documentation',
   author, 'Peng3dnet', 'One line description of project.',
   'Miscellaneous'),
]
